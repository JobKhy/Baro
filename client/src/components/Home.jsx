        ...
        <div className="Balance">
          ...
          <div className="BalanceDisp">
            ...
            <div className="BalanceMenu">
              <button
                onClick={() => {
                  setDisp2(true), setDisp(true);
                }}
              >
                <Item
                  secc={"gasto"}
                  icons={"fa-solid fa-arrow-right-to-bracket"}
                />
              </button>
              <button
                onClick={() => {
                  setDisp(false), setDisp2(false);
                }}
              >
                <Item
                  secc={"ingreso"}
                  icons={"fa-regular fa-square-caret-down"}
                />
              </button>
              <button
                onClick={() => {
                  setDisp(true), setDisp2(false);
                }}
              >
